...
const EVENT_DATA = [
  ...
  { id: 1, title: '好日屋上 アコースティックライブ', category: 'performance', stage: 'C', start: '13:15', end: '13:30', rowStart: 2, rowSpan: 1, user: '屋上で演奏するのが大好きなメンバーでアコースティックライブします🎸🎸🎸🎹🥁', image: 'https://i.gyazo.com/61aa54eb72e5ddb43a1750aa5f014f9f.jpg' },
  ...
  { id: 8, title: 'AI映像づくり', category: 'performance', stage: 'C', start: '15:15', end: '16:15', rowStart: 10, rowSpan: 4, user: 'なべちゃん', image: 'https://i.gyazo.com/3eed8aec0e64d1d7ba52fafd645948d2.jpg', detail: 'Soraを使って動画作りをやります！目指せハリウッド進出！' },
  ...
  { id: 4, title: 'スマホストラップ作り', category: 'workshop', stage: 'C', start: '16:15', end: '17:15', rowStart: 14, rowSpan: 4, user: 'みなみ先生', image: 'https://i.gyazo.com/8a702743f7af57bb8e0e14f5f9eff64e.jpg', detail: 'カラフルなパラコードで、スマホストラップを作ろう！' },
  ...
  { id: 62, title: 'ほぐしの満洲', category: 'shops', stage: 'E', start: '14:30', end: '14:40', rowStart: 7, rowSpan: 1, user: 'ごとちゃん', image: 'https://i.gyazo.com/202c7310a52ccc20a37c0388d6568c13.jpg', detail: '施術時間10分 Max 5人' },
  ...
  { id: 64, title: 'ほぐしの満洲', category: 'shops', stage: 'E', start: '16:30', end: '16:40', rowStart: 15, rowSpan: 1, user: 'ごとちゃん', image: 'https://i.gyazo.com/202c7310a52ccc20a37c0388d6568c13.jpg', detail: '施術時間10分 Max 5人' },
