...
const EVENT_DATA = [
  ...
  { id: 10, title: 'FMネイバーズ〜書籍完成トークショー&みんなに即興インタビュー〜', category: 'performance', stage: 'C', start: '14:30', end: '15:00', rowStart: 7, rowSpan: 2, user: 'DJしおり&ゆか', image: 'https://i.gyazo.com/6bcba51ee07613898664a71336b8cba3.jpg', detail: '集めてきたみんなの「最近よかったこと」をお便りに。ラジオ風にトーク&即興インタビューします🎤' },
