             ...
             <div className="font-bold text-xl leading-tight text-black font-rounded">
               {item.cancelled ? (
                 <>
                   ...
                   <span className="block text-red-600 font-bold mt-1">都合により中止</span>
                 </>
               ) : (
                 item.name
               )}
...
const EVENT_DATA = [
  { id: 0, title: '開会式', category: 'performance', stage: 'C', start: '13:15', end: '13:30', rowStart: 2, rowSpan: 1, user: 'つるみん・うみちゃん', detail: '多分サプライズあり🥰この時間からご参加ください❤️' },
  { id: 1, title: '好日屋上 アコースティックライブ', category: 'performance', stage: 'C', start: '15:00', end: '15:15', rowStart: 9, rowSpan: 1, user: 'うみ・ももちゃん・まゆちゃん・さっちゃま・かのくん', image: 'https://i.gyazo.com/61aa54eb72e5ddb43a1750aa5f014f9f.jpg', detail: '屋上で演奏するのが大好きなメンバーでアコースティックライブします🎸🎸🎸🎹🥁' },
  { id: 11, title: '人生で最後の合唱(旅立ちの日に)', category: 'performance', stage: 'C', start: '15:15', end: '15:45', rowStart: 10, rowSpan: 2, user: '全員 指揮:かよちゃん ピアノ:さっちゃま', image: 'https://i.gyazo.com/c62624ce8f2a843df2a8f1e2d63532aa.png', detail: '人生で最後の合唱になるかもしれないよ！！！！奮ってご参加ください🙌', practiceVideos: { soprano: 'https://www.youtube.com/watch?v=mnM-UYeLz5Q', alto: 'https://www.youtube.com/watch?v=OW2dq5Xg73E', tenor: 'https://m.youtube.com/watch?v=m5ctvhONbsI' } },
  ...
  { id: 12, title: 'かのお悩み相談室', category: 'shops', stage: 'A', start: '14:15', end: '16:00', rowStart: 6, rowSpan: 7, user: 'かのくん(うみの夫)', image: 'https://i.gyazo.com/b9e87d295b700786368bda29c865c97b.jpg', detail: 'かのくんがあなたのお悩み相談にのります！あるいはあなたにかのくんのお悩みを聞いてもらいます！決めるのはア・ナ・タ♡', hideFromTimetable: true, cancelled: true },
  { id: 120, title: 'ちえこお悩み相談室', category: 'shops', stage: 'A', start: '14:15', end: '16:00', rowStart: 6, rowSpan: 7, user: 'ちえちゃん', image: 'https://i.gyazo.com/f1d201cae343f96bec9e115940e85ce3.png', detail: '甘口から10辛まで選べます！', hideFromTimetable: true },
  ...
  { id: 63, title: 'ほぐしの満洲', category: 'shops', stage: 'E', start: '15:30', end: '15:40', rowStart: 11, rowSpan: 1, user: 'ごとちゃん', image: 'https://i.gyazo.com/202c7310a52ccc20a37c0388d6568c13.jpg', detail: '施術時間10分 Max 5人' },
  { id: 64, title: 'ほぐしの満洲', category: 'shops', stage: 'E', start: '16:00', end: '16:10', rowStart: 13, rowSpan: 1, user: 'ごとちゃん', image: 'https://i.gyazo.com/202c7310a52ccc20a37c0388d6568c13.jpg', detail: '施術時間10分 Max 5人' },
  { id: 65, title: 'ほぐしの満洲', category: 'shops', stage: 'E', start: '16:30', end: '16:40', rowStart: 15, rowSpan: 1, user: 'ごとちゃん', image: 'https://i.gyazo.com/202c7310a52ccc20a37c0388d6568c13.jpg', detail: '施術時間10分 Max 5人' },
  { id: 3, title: 'AIで作ったプリクラコーナー', category: 'shops', stage: 'A', start: '16:00', end: '19:00', rowStart: 13, rowSpan: 12, user: 'なべ→うみ', image: 'https://i.gyazo.com/a01278114387d5bca52e7b8a88cbf1ec.jpg', detail: '気になるあの子と思い出のぷりとっちゃお！撮影したデータは、そのままプレゼント🎁' },
  { id: 66, title: 'Soup Stock Esaka', category: 'food', stage: 'F', start: '14:15', end: '18:00', rowStart: 6, rowSpan: 15, user: 'いけめぐ・あまねちゃん', image: 'https://i.gyazo.com/1c0d4ff391dd612c82c5fe1d702d5836.jpg', detail: 'スープ+パンのセット 限定10食' },
  ...
  { id: 101, title: 'ゴチャッと。ぎゅっと。 〜好き、全部のせ〜', category: 'exhibition', stage: null, start: null, end: null, user: 'ななみん', time: '13:00-19:00', stageText: 'GALLERY', image: 'https://i.gyazo.com/df4342fc4892d78691b6302b7ef9d830.jpg', detail: 'つまりは、江坂のみんなさいこう。大好き。' },
  { id: 102, title: 'Esaka no Ake', category: 'exhibition', stage: null, start: null, end: null, user: 'あけちゃん', time: '13:00-19:00', stageText: 'GALLERY', image: 'https://i.gyazo.com/ab01f34725d3efe2a5c123c2ee1b23d0.jpg', detail: 'The Vast Kingdom of Tiny Akechi\n〜日々、武功をあげよ〜' },
    ...
    >
      ...
      >
        ...
        <div className="flex justify-between items-start p-6 md:p-8 pb-4 border-b-2 border-gray-200 shrink-0">
          <h3 className="text-2xl md:text-3xl font-display text-black pr-4">
            {selectedEvent.cancelled ? (
              <>
                <span className="line-through">{selectedEvent.title}</span>
                <span className="block text-red-600 font-bold mt-1">都合により中止</span>
              </>
            ) : (
              selectedEvent.title
             ...
             {scheduleData15Min.map((event, index) => {
               ...
               return (
                 <div
                    ...
                    onClick={() => onEventClick && onEventClick({ title: event.title, user: event.user, start: event.start, end: event.end, stage: stageStyle.name, image: event.image, detail: event.detail, practiceVideos: event.practiceVideos, role: event.role, cancelled: event.cancelled })}
                 >
                    <div className="font-black text-xs md:text-base leading-tight line-clamp-2 text-black font-rounded">
                      {event.cancelled ? (
                        <>
                          <span className="line-through">{event.title}</span>
                          <span className="block text-red-600 font-bold">都合により中止</span>
                        </>
                      ) : (
                        event.title
                      )}
    ...
    EVENT_DATA.forEach(event => {
      ...
      if (!exists) {
        ...
        if (event.title === 'ほぐしの満洲' && event.id === 61) {
          formattedEvent.time = '14:30 / 15:00 / 15:30 / 16:00 / 16:30開始';
        }
