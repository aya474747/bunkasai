...
const TimeSchedule = () => {
  ...
  const scheduleData15Min = [
    { id: 99, title: '喫茶まゆか', stage: 'B', start: '14:15', end: '18:00', rowStart: 6, rowSpan: 15, user: 'まゆちゃん＆あっこたん' },
  ...
  const content = {
    performance: [
      ...
      { name: "アコースティックバンド", desc: "うみ ももちゃん まゆちゃん さっちゃま かのくん", time: "13:15-13:30", stage: "STAGE C" },
      {
        ...
        time: "13:30-14:00",
        stage: "STAGE C",
        detail: "久しぶりに歌っちゃおう！練習時間も設けるから、男子〜！ちゃんとして〜！ってやつもやろう！ 指揮:かよちゃん / ピアノ:さっちゃま"
      },
