...
const EVENT_DATA = [
  ...
  { id: 12, title: 'かのお悩み相談室', category: 'shops', stage: null, start: '14:15', end: '16:00', user: 'かのくん(うみの夫)', image: 'https://i.gyazo.com/b9e87d295b700786368bda29c865c97b.jpg', detail: 'かのくんがあなたのお悩み相談にのります！あるいはあなたにかのくんのお悩みを聞いてもらいます！決めるのはア・ナ・タ♡', cancelled: true },
  ...
  { id: 3, title: 'AIで作ったプリクラコーナー', category: 'shops', stage: 'A', start: '14:15', end: '19:00', rowStart: 6, rowSpan: 19, user: 'なべちゃん', image: 'https://i.gyazo.com/a01278114387d5bca52e7b8a88cbf1ec.jpg', detail: '気になるあの子と思い出のぷりとっちゃお！撮影したデータは、そのままプレゼント🎁' },
